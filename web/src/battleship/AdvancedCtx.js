export class AdvancedCtx {
    ...
    quadraticCurveTo(x1,y1,x2,y2){
        ...
        this.ctx.quadraticCurveTo(dexy1[0]+this.offsetX,dexy1[1]+this.offsetY,dexy2[0]+this.offsetX,dexy2[1]+this.offsetY);
    }
    ...
    bezierCurveTo(x1,y1,x2,y2,x3,y3){
        ...
        this.ctx.bezierCurveTo(dexy1[0]+this.offsetX,dexy1[1]+this.offsetY,dexy2[0]+this.offsetX,dexy2[1]+this.offsetY,dexy3[0]+this.offsetX,dexy3[1]+this.offsetY);
    }
