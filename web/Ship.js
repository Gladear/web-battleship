...
class Ship {
  ...
  draw(own) {
    if (own) {
      ...
      var offsetSwimX =
        Math.cos((this.offsetSwimDirection * (t + this.offsetSwim)) / (1 + this.offsetSwimSpeed)) *
        (1 + this.offsetSwimWidth);
      var offsetSwimY =
        Math.sin(
          (this.offsetSwimDirection * (t + this.offsetSwim)) / (1 + this.offsetSwimSpeed) - 0.5,
        ) *
        (1 + this.offsetSwimWidth);

      advCtx.setParams(
        gridCaseLength * (this.x + 0.5) + offsetSwimX,
        gridCaseHeight * (this.y + 0.5) + offsetSwimY,
        (gridCaseLength / 5) * rot2,
        rot,
      );
      switch (this.type) {
        case 0: //Submarine
  ...
  drawCarrier() {
    ...
    advCtx.lineTo(0.5, 1.75);
    advCtx.lineTo(0.5, 1.9);
    advCtx.moveTo(0.5, 1.75);
    advCtx.lineTo(0.5, 1.6);

    advCtx.stroke();

    advCtx.begin(2, boatStrokeColor, boatFillColor);

    advCtx.moveTo(0.5, -0.5);
    ...
    advCtx.lineTo(0.5, -2.5);
    advCtx.lineTo(0.5, -0.5);
    ...
    advCtx.moveTo(-1.5, -0.5);
    advCtx.lineTo(26.5, -0.5);
    ...
    advCtx.lineTo(0, 2);
    advCtx.lineTo(-0.5, 2);
    advCtx.lineTo(-0.5, 1.5);
    advCtx.lineTo(-1.25, 1.5);
    advCtx.lineTo(-1.5, 0.5);
    advCtx.lineTo(-1.5, -0.5);
  ...
  drawBattleship() {
    ...
    advCtx.lineTo(6.5, -0.5);
    advCtx.lineTo(7, -0.5);
    advCtx.lineTo(7, -1);
    advCtx.lineTo(7.5, -1);
    advCtx.lineTo(7.5, -1.5);
    advCtx.lineTo(8.5, -1.5);
    advCtx.lineTo(8.5, -0.5);
    advCtx.lineTo(9.5, -0.5);
    advCtx.lineTo(9.5, -2);
    ...
    advCtx.moveTo(-1.5, -0.5);
    advCtx.lineTo(9.5, -0.5);
    advCtx.quadraticCurveTo(15.5, -0.75, 16.5, -1);
    advCtx.quadraticCurveTo(15, 1, 15.5, 1.5);
    advCtx.lineTo(10.5, 1.5);
    advCtx.quadraticCurveTo(10.75, 1.9, 11, 2);
    advCtx.bezierCurveTo(11, 2.25, 9, 2.25, 9, 2);
    advCtx.quadraticCurveTo(8.75, 1.9, 8.5, 1.5);
    advCtx.lineTo(5.5, 1.5);
    ...
    advCtx.lineTo(-0.5, 1);
    advCtx.lineTo(-1, 1);
    advCtx.quadraticCurveTo(-1, 0, -1.5, -0.5);
  ...
  drawPatrolBoat() {
    ...
    advCtx.lineTo(-1.5, 1.5);
    advCtx.lineTo(5.5, 1.5);
    advCtx.quadraticCurveTo(7.5, 1, 7.5, -0.5);
  ...
  drawDestroyer() {
    ...
    advCtx.moveTo(-2, 0);
    advCtx.lineTo(7.5, 0);
    advCtx.quadraticCurveTo(8, 0, 8.5, -0.5);
    advCtx.lineTo(12, -0.5);
    advCtx.lineTo(11.5, 0.5);
