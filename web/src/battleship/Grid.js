...
export class Grid {
    ...
    drawIndexes(){
        ...
        for(var i = 1; i < this.nbCol+1; i++){
            ...
            advCtx.write(letter,this.gridColor,this.gridTxtLength,this.caseLength/2,(this.caseHeight+this.gridTxtLength)/2);
        }
        ...
        for(var j = 1; j < this.nbLine+1; j++){
            ...
            advCtx.write(j,this.gridColor,this.gridTxtLength,this.caseLength/2,(this.caseHeight+this.gridTxtLength)/2);
        }
